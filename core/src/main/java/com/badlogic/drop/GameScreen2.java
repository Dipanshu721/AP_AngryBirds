...
public class GameScreen2 implements Screen, BirdLauncher {
    ...
    private Texture backgroundTexture, pauseTexture, retryTexture, saveTexture;
    ...
    public void create() {
        ...
        Texture oldPiggyTexture = new Texture(Gdx.files.internal("oldpiggy.png"));
    ...
    private void assemblePigs() {
        ...
        piggies.add(new oldPiggy(182, 29, world));
        piggies.add(new oldPiggy(208, 29, world));
    }
